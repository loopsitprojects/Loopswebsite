 ...
 * Features a wide, spacious inner opening so trophy images sit 100% inside the ring.
 */
...
export default function AwardCircleWebGL({ size = 320 }: Props) {
  ...
  useEffect(() => {
    ...
    // RAF loop — gentle clockwise rotation around the Z-axis facing the user (never turns edge-on)
    let rafId: number
    const animate = () => {
