...
class ManagePlay extends Page implements HasForms
{
    ...
    protected static ?string $navigationLabel = 'Play Page';
    protected ?string $heading = 'Manage Play Page';
    ...
    {
        $service = Service::where('slug', 'play')->first();
        if (!$service) {
            abort(404, 'Play service page not found.');
        }
    ...
    public function save(): void
    {
        ...
        Notification::make()
            ->title('Play Page configuration saved successfully!')
            ->success()
            ->send();
    }
}
