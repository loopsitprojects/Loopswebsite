...
class ManagePerformanceMarketing extends Page implements HasForms
{
    ...
    protected static ?string $navigationLabel = 'Performance Marketing';
    protected ?string $heading = 'Manage Performance Marketing Page';
    ...
    public function mount(): void
    {
        ...
        if (!$service) {
            abort(404, 'Performance Marketing service page not found.');
        }
    ...
    public function save(): void
    {
        ...
        Notification::make()
            ->title('Performance Marketing Page configuration saved successfully!')
            ->success()
            ->send();
    }
}
