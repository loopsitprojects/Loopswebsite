...
class ManageCreative extends Page implements HasForms
{
    ...
    protected static ?string $navigationLabel = 'Creative Page';
    protected ?string $heading = 'Manage Creative Page';
    ...
    {
        $service = Service::where('slug', 'creative')->first();
        if (!$service) {
            abort(404, 'Creative service page not found.');
        }
    ...
    public function save(): void
    {
        ...
        Notification::make()
            ->title('Creative Page configuration saved successfully!')
            ->success()
            ->send();
    }
}
