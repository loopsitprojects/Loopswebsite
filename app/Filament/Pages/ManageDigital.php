...
class ManageDigital extends Page implements HasForms
{
    ...
    protected static ?string $navigationLabel = 'Digital Page';
    protected ?string $heading = 'Manage Digital Page';
    ...
    {
        $service = Service::where('slug', 'digital')->first();
        if (!$service) {
            abort(404, 'Digital service page not found.');
        }
    ...
    public function save(): void
    {
        ...
        Notification::make()
            ->title('Digital Page configuration saved successfully!')
            ->success()
            ->send();
    }
}
