...
class ManageTech extends Page implements HasForms
{
    ...
    protected static ?string $navigationLabel = 'Tech Page';
    protected ?string $heading = 'Manage Tech Page';
    ...
    {
        $service = Service::where('slug', 'tech')->first();
        if (!$service) {
            abort(404, 'Tech service page not found.');
        }
    ...
    public function save(): void
    {
        ...
        Notification::make()
            ->title('Tech Page configuration saved successfully!')
            ->success()
            ->send();
    }
}
